...
const buttonVariants = cva(
	"inline-flex items-center dark:bg-dark dark:bg-white justify-center text-black dark:text-white whitespace-nowrap rounded-md text-xs font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 uppercase disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				default:
					"bg-primary text-primary-foreground hover:bg-primary/90 hover:text-gray-200 dark:text-dark",
				destructive:
