...
exports.MobileProfileDropDown = MobileProfileDropDown;
    ...
    return (<dropdown_menu_1.DropdownMenu>
			<dropdown_menu_1.DropdownMenuTrigger asChild>
				<div className="flex cursor-pointer items-center justify-start gap-2">
					<img src={user?.picture} alt={user?.fullName} className="rounded-full w-8 h-8 object-cover"/>
				</div>
			</dropdown_menu_1.DropdownMenuTrigger>
			<dropdown_menu_1.DropdownMenuContent className="w-56 z-100" style={{ zIndex: 4000 }}>
