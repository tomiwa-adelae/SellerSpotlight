		...
		<div>
			...
			<div className="min-h-[70vh] flex flex-col items-start text-left justify-center gap-6 w-full md:w-5/6 mx-auto">
				...
				<p className="text-sm md:text-base w-full md:w-5/6">
					...
					shopping, discover trusted sellers, read honest reviews, and
					make informed choices with ease. SellerSpotlight is your
					go-to platform for transparency and trust in every
					transaction.
				</p>
				<Button asChild>
