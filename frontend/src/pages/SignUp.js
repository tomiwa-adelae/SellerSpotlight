...
const SignUp = () => {
    ...
    async function onSubmit(data) {
        try {
            const res = await axios_1.default.post(`${constants_1.BASE_URL}/api/users`, {
                ...data,
    ...
    return (<div className="flex items-center justify-center min-h-screen h-screen relative p-6 md:p-0">
            ...
            : "Sign up"}
							...
							<small className="mt-4 block">
								...
								<react_router_dom_1.Link to="/sign-in" className="font-semibold">
									Login now
			...
			<div className="flex-1 fixed top-0 left-0 w-screen md:static">
				<img src={"/assets/images/signup-img.jpg"} className="h-screen object-cover w-screen"/>
			</div>
		</div>);
};
